...
openai.api_key = 'GPT_API_KEY'  # Replace with your OpenAI API key

class Chatbot:
    def __init__(self, window):
        window.title('Bot Assistant')
        ...
        self.message_session.config(
            width=55, height=15, bg="gray", fg="white", state='disabled')
        ...
        self.send_button.place(x=140, y=290)
        self.Message_Entry.place(x=30, y=260)
        self.Brain = {
            'hello': ['Hello!', 'Hi there!', 'Greetings!'],
            'how are you': ["I'm good. How about you?", "I'm fine, thank you.", "I'm great!"],
    ...
    def reply_to_you(self, event=None):
        ...
        reply = 'Bot: ' + response.choices[0].text.strip() + '\n'
